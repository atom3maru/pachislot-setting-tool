  ...
  return (
    <SectionCard title="ST終了画面・特定枚数・トロフィー" icon="🖼️">
      <div className="space-y-4">
        <div>
          <h3 className="text-xs font-semibold text-gray-500 mb-2">ST終了画面</h3>
        ...
        <div>
          <h3 className="text-xs font-semibold text-gray-500 mb-2">特定枚数到達示唆</h3>
        ...
        <div>
          <h3 className="text-xs font-semibold text-gray-500 mb-2">サミートロフィー（ST終了時）</h3>
