  ...
  return (
    <SectionCard title="その他" icon="📋">
      <div className="space-y-4">
        <div>
          <h3 className="text-xs font-semibold text-gray-500 dark:text-gray-400 mb-2">駿城ボーナス中・単チャンス目</h3>
        ...
        <div>
          <h3 className="text-xs font-semibold text-gray-500 dark:text-gray-400 mb-2">アイテムくじ</h3>
          <div className="grid grid-cols-2 gap-3">
        ...
        <div>
          <h3 className="text-xs font-semibold text-gray-500 dark:text-gray-400 mb-2">参考情報</h3>
          <div className="grid grid-cols-2 gap-3">
