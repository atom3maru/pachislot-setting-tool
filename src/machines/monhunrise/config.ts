...
const config: MachineConfig = {
      ...
      groups: [
        {
          ...
          fields: [
            ...
            { key: 'e_quest', label: 'クエスト画面', hint: '高設定示唆' },
            { key: 'e_elder', label: '古龍画面', hint: '設定4以上濃厚' },
  ...
  // 設定1,2,4,5,6の5段階
  probEntries: [
    { key: 'atCnt', totalKey: 'totalG', rates: [1/358.2, 1/342.6, 1/298.7, 1/275.3, 1/254.8] },
    { key: 'koyakuCnt', totalKey: 'totalG', rates: [1/108.5, 1/104.2, 1/95.8, 1/90.6, 1/86.1] },
  ],
  ...
  categoricalGroups: [
    {
      keys: ['e_normal', 'e_quest', 'e_elder', 'e_special'],
      rates: {
        e_normal:  [0.980, 0.965, 0.928, 0.902, 0.868],
        e_quest:   [0.015, 0.025, 0.048, 0.063, 0.082],
        e_elder:   [0.005, 0.010, 0.024, 0.033, 0.045],
  ...
  getHints: (input) => {
    ...
    if (!['e_normal', 'e_quest', 'e_elder', 'e_special'].some(k => (input[k] ?? 0) > 0))
