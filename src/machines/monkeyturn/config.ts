...
const config: MachineConfig = {
  ...
  guide: {
    settingHunt: [
      '5枚役確率が最重要（設定1: 1/38.15 → 設定6: 1/22.53、約1.69倍差）',
      'AT初当たり確率（設定1: 1/299.8 → 設定6: 1/222.9、約1.35倍差）',
      'ケロットトロフィー：銅=設定2以上、金=設定4以上、ケロット柄=設定5以上、虹=設定6確定',
      '弱レア役からのAT直撃発生で設定4以上確定（設定4: 0.4%、設定6: 3.1%）',
      'SGメダル黒出現は設定4以上示唆（設定1: 1%、設定6: 4.5%）',
      '獲得枚数456OVER=設定4以上、803OVER=設定5以上、666OVER=設定6確定',
    ],
    morningCheck: [
      'リセット時は天井795G→495Gに大幅短縮。0Gから期待値プラス',
      'ガックンチェックでリセット判別。1G回して出目変化を確認',
      '周期5スルー6回目はAT確定。スルー回数を必ずデータ機で確認',
      'チャージ間81G天井もあり。リセット台は積極的に狙える',
    ],
    quitTiming: [
      'AT終了後はヘルメット・サイド液晶・SGメダル・トロフィーを全確認してからやめ',
      'Vストック保持中は絶対に続行。ストック示唆演出を見逃さない',
      '残り天井200G以内（通常595G〜/リセット295G〜）なら打ち切り推奨',
      'AT初当たり1/280以上・5枚役1/30以上を3000G時点で下回るなら低設定濃厚',
    ],
  },
