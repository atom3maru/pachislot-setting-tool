...
const config: MachineConfig = {
      ...
      groups: [
        {
          ...
          fields: [
            ...
            { key: 'e_alisa', label: 'アリサ画面', hint: '高設定示唆' },
            { key: 'e_nova', label: 'ノヴァ画面', hint: '設定4以上濃厚' },
  ...
  // 設定1,2,4,5,6の5段階
  probEntries: [
    { key: 'atCnt', totalKey: 'totalG', rates: [1/342.8, 1/328.5, 1/287.6, 1/265.2, 1/243.7] },
    { key: 'koyakuCnt', totalKey: 'totalG', rates: [1/100.5, 1/96.8, 1/89.5, 1/84.8, 1/80.6] },
  ],
  ...
  categoricalGroups: [
    {
      keys: ['e_normal', 'e_alisa', 'e_nova', 'e_special'],
      rates: {
        e_normal:  [0.978, 0.963, 0.925, 0.900, 0.866],
        e_alisa:   [0.017, 0.027, 0.050, 0.065, 0.084],
        e_nova:    [0.005, 0.010, 0.025, 0.033, 0.045],
  ...
  getHints: (input) => {
    ...
    if (!['e_normal', 'e_alisa', 'e_nova', 'e_special'].some(k => (input[k] ?? 0) > 0))
