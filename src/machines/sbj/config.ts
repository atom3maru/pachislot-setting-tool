...
const config: MachineConfig = {
  ...
  guide: {
    settingHunt: [
      '斜めスイカ確率が最重要（設定1: 1/99.9 → 設定6: 1/83.9、約1.19倍差）。2000G以上で判断',
      'スイカST直撃率に大きな設定差（設定1: 0.4% → 設定6: 1.6%、4倍差）。1回でも高設定期待大',
      'チャンス目→高確移行率（設定1: 40.1% → 設定6: 59.5%）も重要な判別要素',
      'ケロットトロフィー：銅=設定2↑、銀=設定3↑、金=設定4↑、ケロット柄=設定5↑、虹=設定6濃厚',
      'REGキャラカード：リナ=高設定示唆強、ジョーカー=設定5↑、3人=設定6濃厚',
      'ダイスゾロ目（150G/450G/750G時）：4ゾロ=設定4↑、5ゾロ=設定5↑、6ゾロ=設定6濃厚',
    ],
    morningCheck: [
      'リセット時は天井が666Gに短縮（通常999G）。550G付近から期待値プラス',
      'REGスルー天井は4連続（REG4回でBIG確定）。前日スルー回数を確認',
      'スイカ100回到達でも天井発動。スイカカウントを朝一から開始',
      'リセット判別：リオチャンス高確0〜100Gゾーンの挙動で推測',
    ],
    quitTiming: [
      'リオチャンス高確ゾーン0〜100G消化後にやめ判断。即やめ厳禁',
      'リセット天井狙い：550G以上なら666G天井まで打ち切り推奨（期待値+2500円）',
      'REGスルー3回なら次回BIG確定の4スルー天井まで続行必須',
      '2000G消化してスイカ確率1/105以上＋ST直撃0回ならやめ検討',
      '通常天井残り300G以内（700G〜）なら天井999Gまで打ち切り推奨',
    ],
  },
