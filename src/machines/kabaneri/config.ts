...
const config: MachineConfig = {
  ...
  guide: {
    settingHunt: [
      '下段ベル確率が最重要（設定1: 1/121.1 → 設定6: 1/99.1、約1.22倍差）。2000G以上で判断',
      '3周期目ボーナス当選率に最大設定差（設定1: 12.5% → 設定6: 25.0%）。到達・当選回数を必ず記録',
    ...
    morningCheck: [
      ...
      'リセット台は100〜200G付近から期待値プラス。データカウンターで前日最終G数を確認し据え置き判別',
      '周期天井は最大6周期でボーナス確定（短縮時は4周期）。サブ液晶で現在の周期数を必ず確認',
      '朝一1G目にサブ液晶おみくじを確認。高設定示唆パターンが出れば続行判断の材料になる',
      '前日800G以上ハマりの据え置き台は天井間近のため狙い目。周期数も合わせて確認',
    ],
    quitTiming: [
      'ST・ボーナス終了後の有利区間リセットを確認してからやめる。即やめ厳禁',
      '2000G消化で下段ベル1/115以下かつ確定演出なしなら設定1-2濃厚。やめ推奨',
      'ボーナス初当たり1/300以上が続きST終了画面が通常のみなら低設定の可能性大',
      '残り天井200G以内（通常時800G付近）なら天井まで打ち切り推奨',
      '設定変更後・ST駆け抜け後は天井596Gのため、300G付近でも続行価値あり',
    ],
  },
  ...
  playGuide: {
    ...
    reelStops: [
      {
        name: '下段ベル', how: '左BAR狙い', stopForm: 'ベルが下段に揃う',
        settingDiff: '設定1: 1/121.1 → 設定6: 1/99.1',
        reelPattern: { left: ['空', '空', 'ベル'], center: ['空', '空', 'ベル'], right: ['空', '空', 'ベル'], highlightLine: 'bottom' },
      },
      {
      ...
      {
        name: '中段チェリー', how: '左BAR狙い', stopForm: 'チェリーが左リール中段に停止（確定役）',
