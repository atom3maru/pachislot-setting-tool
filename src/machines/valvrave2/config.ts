...
const config: MachineConfig = {
  ...
  guide: {
    settingHunt: [
      'ハラキリドライブ発生率が最重要（設定1: 6% → 設定5/6: 28%、約4.7倍差）。AT連チャン数と発生回数を必ず記録',
      'BAR揃いAT直撃に設定差（設定1: 3% → 設定6: 7%）。BAR揃い総数と直撃回数をカウント',
      '終了画面枠色：紫枠=設定2以上、銀枠=設定4以上濃厚、金枠=設定6濃厚。毎回確認必須',
      '獲得枚数表示：456枚OVER=設定4以上、555枚OVER=設定5以上、666枚OVER=設定6濃厚',
      'ゾロ目G数上乗せ：+22G=設定2以上、+44G=設定4以上、+66G=設定6濃厚',
      '初当たり確率は全設定ほぼ共通（1/456〜1/476）。設定差はAT中性能に集中',
    ],
    morningCheck: [
      '天井は周期6周期/CZ間999G/AT間1500Gの三重構造。リセット時は周期3周期/AT間1000Gに短縮',
      'リセット台は周期天井が3周期に半減するため朝一狙い目。300G付近から期待値プラス',
      'リセット判別は朝一の周期到達速度で推測。通常より早くCZに到達すればリセット濃厚',
      '前日AT間ハマりの据え置き台はAT間天井1500G狙いも有効',
    ],
    quitTiming: [
      'AT終了後66Gの引き戻しゾーンを必ず消化してからやめる。即やめ厳禁',
      'ハラキリドライブ未発生が5連チャン以上続いたら設定1-2濃厚。やめ推奨',
      '終了画面が白枠のみ＋獲得枚数表示なしが続くなら低設定の可能性大',
      '残りAT間天井300G以内なら天井まで打ち切り推奨',
      'リセット後はAT間天井1000Gのため、700G付近でも続行価値あり',
    ],
  },
  ...
  playGuide: {
    ...
    reelStops: [
      ...
      { name: 'BAR揃い', how: '左BAR狙い', stopForm: 'BAR図柄が一直線に揃う（リプレイフラグ）',
        reelPattern: { left: ['空', 'BAR', '空'], center: ['空', 'BAR', '空'], right: ['空', 'BAR', '空'], highlightLine: 'center' } },
