...
const MACHINES: MachineListItem[] = [
  ...
  },
  {
    ...
    description: 'AT初当たり・CZ確率・天井999G・設定示唆演出',
    icon: '🔫',
    disabled: true,
    disabledReason: '2026年4月6日導入予定 - 導入後に解析データを反映します',
  },
  {
    id: 'kyokousuiri',
    name: 'L虚構推理',
    ...
    description: 'ボーナス初当たり・CZ確率・天井1000G・ダイナマイトトロフィー',
    icon: '🔮',
    disabled: true,
    disabledReason: '2026年4月6日導入予定 - 導入後に解析データを反映します',
  },
  {
    ...
    description: 'ボーナス合算確率・BT終了画面・天井なしBT機',
    icon: '🌈',
    disabled: true,
    disabledReason: '2026年4月6日導入予定 - 導入後に解析データを反映します',
  },
  {
    ...
    description: 'AT初当たり・獲得枚数表示・御白洲ビジョン・天井CZ1000G/AT1500G',
    icon: '🏯',
    disabled: true,
    disabledReason: '2026年4月6日導入予定 - 導入後に解析データを反映します',
  },
  {
    ...
    description: 'AT初当たり・天井CZ800G/AT1400G・リセット短縮あり',
    icon: '🦄',
    disabled: true,
    disabledReason: '2026年4月6日導入予定 - 導入後に解析データを反映します',
  },
